...
class ForestHouse extends AbstractScene
{
    ...
    public function __construct()
    {
        ...
        $this->monsters = [
            ...
            new SkeletonBoss(0, ['x' => -82, 'y' => 0, 'z' => 10], [], [new Gold(1)]),
            new SkeletonWarrior(0, ['x' => -104, 'y' => 0, 'z' => -9], [], [new Gold(1)]),
            new SkeletonWarrior(0, ['x' => -113, 'y' => 0, 'z' => -54], [], [new Gold(1)]),
            new SkeletonWarrior(0, ['x' => -120, 'y' => 0, 'z' => -33], [], [new Gold(1)]),
